...
namespace BibliotecaAPI.Controllers.V2
{
    ...
    {
        // Instancia del context para hacer inyección en la BD
        ...
        // Método Constructor para asignar el context al instanciar el controlador en otra clase
        ...
        public async Task<ActionResult> Filtrar([FromQuery] AutorFiltroDTO autorFiltroDTO) {
            ...
            // Filtro si el autor tiene libros
            ...
            // Filtrar por nombre de titulo de libro
            ...
            // Filtrar por nombre del Campo y de forma "asc" o "des" (uso de libreria Linq.Dynamic)
            ...
            // Filtrar si se incluyen libros, usar el DTO AutorConLibrosDTO si no el AutorDTO
            if (autorFiltroDTO.IncluirLibros) {
